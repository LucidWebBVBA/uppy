...
```html
<link rel="stylesheet" href="https://transloadit.edgly.net/releases/uppy/v1.20.3/robodog.min.css">
<script src="https://transloadit.edgly.net/releases/uppy/v1.20.3/robodog.min.js"></script>
```
