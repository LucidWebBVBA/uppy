...
<a href="https://www.npmjs.com/package/@lucidweb/uppy-utils"><img src="https://img.shields.io/npm/v/@lucidweb/uppy-utils.svg?style=flat-square"></a>
...
```bash
$ npm install @lucidweb/uppy-utils --save
```
