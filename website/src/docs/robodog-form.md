...
```html
<!-- The new Robodog way! -->
<script src="//transloadit.edgly.net/releases/uppy/robodog/v1.10.0/robodog.min.js"></script>
...
```html
<head>
  <link rel="stylesheet" href="https://transloadit.edgly.net/releases/uppy/robodog/v1.10.0/robodog.min.css">
</head>
```
...
<html>
  ...
  <body>
    ...
    <script src="https://transloadit.edgly.net/releases/uppy/robodog/v1.10.0/robodog.min.js"></script>
